...
<body style="margin: 0; padding: 0; height: 100vh; background-image: url('img/motor.jpg'); background-size: cover; color: black; font-size: 1rem;">
    <div class="container text-center">
        <div style="text-align: center;">
            <a href="index.php" style="display: inline-block;">
                <img src="img/17s logo.png" alt="Logo" style="max-width: 200px; margin-top: 20px;">
            </a>
        </div>
